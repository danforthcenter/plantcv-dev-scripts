...
def options():
    ...
    parser.add_argument("-m", "--roi", help="Input region of interest file.", required=False, default="/home/mgehan/plantcv/masks/vis_tv/mask_brass_tv_z1500_L1.png")
...
############################# Use VIS image mask for NIR image#########################
  ...
  device,newmask=pcv.crop_position_mask(nir,nmask,device,15,0,"top","right",args.debug)
