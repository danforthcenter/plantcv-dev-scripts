...
def main():
  ...
  # Define ROI
  device, roi1, roi_hierarchy= pcv.define_roi(masked2,'rectangle', device, None, 'default', args.debug,True, 550, 0,-600,-100)
  ...
  device, boundary_header,boundary_data, boundary_img1= pcv.analyze_bound(img, args.image,obj, mask, 20, device,args.debug,outfile)
...
############################# Use VIS image mask for NIR image#########################
  ...
  device,newmask=pcv.crop_position_mask(nir,nmask,device,81,3,"bottom","right",args.debug)
